...
namespace IdentityServer.Dashboard
{
    /// <summary>
    ...
    /// </summary>
  //  [SecurityHeaders]
    public class AccountController_UserManager : Controller
    {
        ...
        public AccountController_UserManager(
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            var user = await _users.FindByLoginAsync(provider, userId);
            if (user == null)
            {
